...
local treesitter = {'nvim-treesitter/nvim-treesitter',
    ...
    config = function()
        ...
        ts.setup({})
        ts.install({ "lua", "sql", "odin", "c_sharp" })
...
local fff = {'dmtrKovalenko/fff.nvim',
    build = function()
...
local go_up = {'nullromo/go-up.nvim',
...
-- Powershell LSP
local powershell = {'TheLeoP/powershell.nvim',
    ft = { 'ps1' },
    opts = {
...
local ninety_nine = {"ThePrimeagen/99",
    config = function()
